...
function OfficerPanel.BuildRulesTab(rc)
    ...
    capEb:SetBackdropColor(unpack(SchlingelInc.Constants.FORM_COLORS.FORM_BG))
    capEb:SetBackdropBorderColor(unpack(SchlingelInc.Constants.FORM_COLORS.FORM_BORDER))
